...
WebUI.setText(findTestObject('Object Repository/Page_Account Login/input_E-Mail Address_email'), uname)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Account Login/input_Password_password'), pwd)
...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_My Account'))
